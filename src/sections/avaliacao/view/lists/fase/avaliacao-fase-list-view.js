...
//
import AvaliacaoFaseTableRow from './avaliacao-fase-table-row';
...
export default function AvaliacaoFaseListView() {
      ...
      if (por == 'turma') {
        await registroAprendizagemMethods
          ...
          .catch(async (error) => {
            ...
            setErrorMsg(msg || 'Erro de comunicação com a API de registro aprendizagem fase');
            buscandoCSV.onFalse();
          });
      } else if (por == 'escola') {
        await registroAprendizagemMethods
