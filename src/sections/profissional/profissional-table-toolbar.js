          ...
          action={
            <Button
              ...
              onClick={() => {
                ...
                a.href = url;
                a.download = csvFilename || 'exportacao_profissionais.csv';
                a.click();
        ...
        {(!buscandoCSV.value) &&
          <MenuItem
            onClick={() => {
              ...
              profissionalMethods.exportFile(query).then((result) => {
                const filename = result.headers['content-disposition']
                  ?.split('filename=')[1]?.replace(/"/g, '') ?? 'exportacao_profissionais.csv';
              ...
              .catch(async (error) => {
                ...
                setErrorMsg(msg || 'Erro de comunicação com a API de profissionais.');
                buscandoCSV.onFalse();
              });
            }}
          >
