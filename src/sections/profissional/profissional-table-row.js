...
export default function ProfissionalTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow }) {
  const { id, nome, email, funcao, escola, zona } = row;
  ...
  return (
    <>
      ...
      <ProfissionalQuickEditForm currentTurma={row} open={quickEdit.value} onClose={quickEdit.onFalse} />
      ...
      <ConfirmDialog
        ...
        content="Tem certeza que deseja excluir o profissional?"
        action={
