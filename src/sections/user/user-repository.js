...
export const getAllUsersPaginado = ({offset=0, limit=100, nome='', escolas='', funcao='', zona='', status=''}) => axios.get(endpoints.user.list.concat(`?limit=${limit}&offset=${offset}&nome=${nome}&escola_id=${escolas}&funcao_id=${funcao}&zona_id=${zona}&status=${status}`));
