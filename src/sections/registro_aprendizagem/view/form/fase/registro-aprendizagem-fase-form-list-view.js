...
export default function RegistroAprendizagemFaseFormListView({ turmaInicial, bimestreInicial }) {
  ...
  const { limparMapCache, buscaMelhorResultadoHistoricoPorTurma } = useContext(RegistroAprendizagemContext);
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'xxl'}>
      <CustomBreadcrumbs
        ...
        youtubeLink="https://www.youtube.com/embed/AFM9adKIDX8?si=IJdxDNMtQyyGijwz&cc_load_policy=1"
        sx={{
          mb: { xs: 3, md: 5 },
        }}
      />
