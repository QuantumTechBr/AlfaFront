    ...
    <>
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        ...
        <Card>
          ...
          <Button variant="contained" onClick={preencheGraficos}>Aplicar filtro ao grafico</Button>

          <AppAvaliacaoDiagnostico title="Grafico Diagnóstico" list={dados.avaliacao_diagnostico} subheader="" />
