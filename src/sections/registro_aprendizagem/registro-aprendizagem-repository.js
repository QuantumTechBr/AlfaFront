...
export const exportFileDiagnosticoList = (query) => axios.get(endpoints.registro_aprendizagem.diagnostico.idsTurmaList.concat(`/?`).concat(query));
...
export const getListIdTurmaRegistroAprendizagemFase = ({turmaId='', bimestreId=''}) => axios.get(endpoints.registro_aprendizagem.fase.idsTurmaList.concat(`/?turma=${turmaId}&bimestre=${bimestreId}`))
export const exportFileFaseList = (query) => axios.get(endpoints.registro_aprendizagem.fase.idsTurmaList.concat(`/?`).concat(query));
