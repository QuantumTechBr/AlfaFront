...
export const getAllAlunos = ({offset=0, limit=100, nome='', turmas='', escolas='', matricula=''}) => axios.get(endpoints.aluno.list.concat(`?limit=${limit}&offset=${offset}&turmas=${turmas}&escolas=${escolas}&matricula=${matricula}&nome=${nome}`));
